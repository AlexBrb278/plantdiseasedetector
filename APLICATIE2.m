classdef APLICATIE2 < matlab.apps.AppBase
    ...
    % Create UIFigure and components
        function createComponents(app)
            ...
            imshow('C:\Users\alexb\Desktop\imaginefundal.jpg', 'Parent', app.BackgroundAxes); % Set background image here
            ...
            app.ReturnButton.Icon = fullfile('Desktop','Facultate','ProiectMatlabcod','return-button.png');
            app.ReturnButton.Text = '';
            app.ReturnButton.BackgroundColor = [255/255, 228/255, 181/255];
            %app.ReturnButton.FontColor = [1 1 0];
